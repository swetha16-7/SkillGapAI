...
function displayPartiallyMatched(partiallyMatched) {
    const container = document.getElementById('partially-matched');
    container.innerHTML = '';
    
    const allPartial = [
        ...partiallyMatched.technical,
        ...partiallyMatched.soft
    ];
    
    if (allPartial.length === 0) {
        container.innerHTML = '<span style="color: #7f8c8d; font-style: italic;">No partially matching skills identified for this role</span>';
        return;
    }
...
function createActionPlan(analysis) {
    ...
    if (criticalSkills.length > 0) {
        ...
        displaySkills('critical-skills-list', criticalSkills, 'missing');
    } else {
    ...
    if (matchedSkills.length > 0) {
        ...
        displaySkills('strengths-list', matchedSkills, 'matched');
    } else {
...
const conversationalResponses = [
    ...
    "I love explaining this part - it's really useful!",
